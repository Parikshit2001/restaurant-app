...
function User() {
  ...
  return (
    <div onClick={() => setShowOrder(false)} className="bg-white min-h-screen">
      <div className="mx-2">
        <div>
      ...
      >
        ...
        {total > 0 && (
          <div className="bg-red-500 mx-2 py-2 rounded px-2 flex justify-between items-center">
            ...
            <div>
              <button className="bg-white text-red-500 font-bold py-1 px-2 rounded flex items-center gap-2">
